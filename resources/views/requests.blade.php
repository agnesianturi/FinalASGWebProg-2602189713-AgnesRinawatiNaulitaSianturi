                    ...
                    <div class="col-4">
                        <div class="card card-hover">
                            <div class="card-header">
                                <h6 style="margin:0">{{ $r->name }}</h6>
                                <p style="margin:0; font-size: 0.7rem; font-kerning: auto; padding:0;">{{ $r->fieldsOfWork }}</p>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <form method="POST" action="{{ route('requests.destroy', $r->request_id) }}">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" style="border: none; background:none;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="25" fill="rgb(50, 107, 198)" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">

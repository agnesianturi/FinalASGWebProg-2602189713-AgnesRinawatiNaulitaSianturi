    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg text-white" style="background-color: rgb(50, 107, 198); padding-left: 1rem; padding-right: 1rem">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" style="margin-left: 20rem">
                  <li class="nav-item" style="padding-right: 1rem">
                    <a class="nav-link" @yield('activeHome') aria-current="page" href="{{ route('user.index') }}">@lang('navigation.Home')</a>
                  </li>
                  <li class="nav-item" style="padding-right: 1rem">
                    <a class="nav-link" @yield('activeRequests') href="{{ route('requests.index') }}">@lang('navigation.Requests')</a>
                  </li>
                  <li class="nav-item" style="padding-right: 1rem">
                    <a class="nav-link" @yield('activeFriends') href="{{ route('friendship.index') }}">Friends</a>
                  </li>
            ...
            @if (Auth::check())
                <div class="dropdown" style="margin-right: 5rem">
                    <button class="btn btn-secondary dropdown-toggle d-flex align-items-center" style="background-color: inherit; border-color: inherit" type="button" id="dropdownProfile" data-bs-toggle="dropdown" aria-expanded="false">
                        <span style="padding-right: 0.5rem">Welcome, {{ Auth::user()->name }}</span>
            ...
            @endif
              ...
              <div class="navbar-language" style="margin-right: 3rem">
